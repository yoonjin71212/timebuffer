...
{
    CLASSNAME=kmalloc(sizeof(char)*UUID_LEN,GFP_USER);
    NAME=kmalloc(sizeof(char)*UUID_LEN,GFP_USER);
    GET_UUID(NAME);   /*Name is by UUID*/
    __device_name__=kmalloc(sizeof(char)*UUID_LEN,GFP_USER);
    /**********/
    ...
    lst=kmalloc(sizeof(list),GFP_USER);    /*List is allocated here*/
